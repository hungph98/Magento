...
use Source\App\Api\Data\ProductInterface;
use Source\App\Model\Product;
use Source\App\Model\Product\Type\AbstractType;
use Source\App\Model\Product\Type\Pool;
use Source\App\Model\Product\Type\Price;
use Source\App\Model\Product\Type\Price\Factory as PriceFactory;
use Source\App\Model\Product\Type\Simple;
use Source\App\Model\Product\ProductTypes\ConfigInterface;
...
class Type implements OptionSourceInterface
{
    ...
    /**
     * Frontend types by type indexing priority
     *
     * @var array
     */
     ...
     */
    public function factory(ProductInterface $product): AbstractType
    {
        $types = $this->getTypes();
    ...
    /**
     * Frontend type price model factory
     *
    ...
    /**
     * Get Frontend Price Info object
     *
